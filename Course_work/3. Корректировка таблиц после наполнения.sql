...
-- Забыл создать стобцы created_at и updated_at
ALTER TABLE celebs_profiles ADD COLUMN created_at DATETIME;
ALTER TABLE celebs_profiles ADD COLUMN updated_at DATETIME;
UPDATE celebs_profiles SET created_at = DATE_ADD('2010-01-01',INTERVAL ceiling(rand() * (datediff('2020-01-01','2010-01-01')+1)) -1 day);
UPDATE celebs_profiles SET updated_at = DATE_ADD('2010-01-01', INTERVAL ceiling(rand() * (datediff('2020-01-01','2010-01-01') + 1)) - 1 day);
